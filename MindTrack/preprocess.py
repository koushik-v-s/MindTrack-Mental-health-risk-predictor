...
def preprocess_data(filepath):
    ...
    joblib.dump(scaler_robust, 'artifacts/scaler_robust.pkl')
    joblib.dump(scaler_standard, 'artifacts/scaler_standard.pkl')

    print("Scalers saved: scaler_robust.pkl, scaler_standard.pkl")
